...
class Suceso1 extends Punto3d
{
    private HoraExacta tiempo;
    private Punto3d lugar;
    private String descripcion;
    Suceso1(double x,double y,double z,HoraExacta tiempo,String descripcion)
    {
        super(x, y, z);
        this.tiempo = tiempo;
    ...
    public boolean Equals(Object otro)
    {
        ...
        Suceso1 alguien = (Suceso1) otro;
        boolean iguales=false;
        if ( this.lugar.equals(alguien) && this.descripcion == alguien.descripcion&& this.tiempo.Equals(tiempo                 ))
        {
            iguales=true;
        }
